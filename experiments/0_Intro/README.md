# Introduction to GenAI for Web UI Testing

## Workshop Overview

A hands-on, 1-day workshop exploring how Generative AI transforms web UI testing — from LLM fundamentals to autonomous testing agents.

## What You'll Learn

| #   | Topic                     | What we do                                                     |
| --- | ------------------------- | -------------------------------------------------------------- |
| 1   | **LLM Basics**            | Explore temperature, context windows, and model behavior       |
| 2   | **Vibe Coding**           | Build a web app from a prompt using Lovable.dev                |
